TEMPLATES = {
    "offer": """Dear {candidateName},

We are pleased to offer you the position of {jobRole} in our {department} department at LEARN, starting on {startDate}.
Your salary will be {salary} per month.
